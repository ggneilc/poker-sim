...
class BlackjackPlayer(models.Model):
    ...
    curr_bet = models.IntegerField(null=True, blank=True, default=None)
...
class BlackjackRoom(Room):
    ...
    # TODO : add house_payout to determine how much money dealer has made/lost
